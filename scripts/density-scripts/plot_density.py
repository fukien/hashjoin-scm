...
PHJ_LOG_PATH = "../../logs/density-logs/"
NPHJ_LOG_PATH = "../../logs/density-logs/"
FIG_PATH = "../../figs/density-figs/"
...
if __name__ == "__main__":
	...
	plt.title("density {}".format(mem_type))
	...
	plt.xlabel("Density", fontsize=default_fontsize)
	...
	plt.savefig(os.path.join(FIG_PATH, "density_{}.png".format(mem_type)), bbox_inches="tight", format="png")
	# plt.title("", fontsize=default_fontsize)
	# plt.savefig(os.path.join(FIG_PATH, "density_{}.pdf".format(mem_type)), bbox_inches="tight", format="pdf")
	# os.system("/Applications/Inkscape.app/Contents/MacOS/inkscape {} --export-eps={}".format(
	# 		os.path.join(FIG_PATH, "density_{}.pdf".format(mem_type)),
	# 		os.path.join(FIG_PATH, "density_{}.eps".format(mem_type))
	# 	)
	# )
