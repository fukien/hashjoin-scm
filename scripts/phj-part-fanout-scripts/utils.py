...
def get_data_from_log(algo, mem_type, passnum):
	filepath = os.path.join(LOG_PATH, "{}_fanout_{}_{}.log".format(algo, mem_type, passnum))
...
def get_counter_from_log(algo, mem_type, passnum, event, event_flag):
	filepath = os.path.join(LOG_PATH, "{}_fanout_{}_{}_counter.log".format(algo, mem_type, passnum))
	buildpart_time_list = []
	probejoin_time_list = []
	total_time_list = []
