...
SHRll_SC_PAYLOAD_NVM_LOG=$DIR_PATH/shrll_sc_payload_nvm.log
rm $SHRll_SC_PAYLOAD_NVM_LOG
SHRll_LP_PAYLOAD_NVM_LOG=$DIR_PATH/shrll_lp_payload_nvm.log
rm $SHRll_LP_PAYLOAD_NVM_LOG
SHRll_HR_PAYLOAD_NVM_LOG=$DIR_PATH/shrll_hr_payload_nvm.log
rm $SHRll_HR_PAYLOAD_NVM_LOG
# SHRll_HRO_PAYLOAD_NVM_LOG=$DIR_PATH/shrll_hro_payload_nvm.log
# rm $SHRll_HRO_PAYLOAD_NVM_LOG

SHRcm_BC_PAYLOAD_NVM_LOG=$DIR_PATH/shrcm_bc_payload_nvm.log
rm $SHRcm_BC_PAYLOAD_NVM_LOG
SHRcm_SC_PAYLOAD_NVM_LOG=$DIR_PATH/shrcm_sc_payload_nvm.log
rm $SHRcm_SC_PAYLOAD_NVM_LOG
SHRcm_LP_PAYLOAD_NVM_LOG=$DIR_PATH/shrcm_lp_payload_nvm.log
rm $SHRcm_LP_PAYLOAD_NVM_LOG
SHRcm_HR_PAYLOAD_NVM_LOG=$DIR_PATH/shrcm_hr_payload_nvm.log
rm $SHRcm_HR_PAYLOAD_NVM_LOG
# SHRcm_HRO_PAYLOAD_NVM_LOG=$DIR_PATH/shrcm_hro_payload_nvm.log
# rm $SHRcm_HRO_PAYLOAD_NVM_LOG

INDll_SC_PAYLOAD_NVM_LOG=$DIR_PATH/indll_sc_payload_nvm.log
rm $INDll_SC_PAYLOAD_NVM_LOG
INDll_LP_PAYLOAD_NVM_LOG=$DIR_PATH/indll_lp_payload_nvm.log
rm $INDll_LP_PAYLOAD_NVM_LOG
INDll_HR_PAYLOAD_NVM_LOG=$DIR_PATH/indll_hr_payload_nvm.log
rm $INDll_HR_PAYLOAD_NVM_LOG
# INDll_HRO_PAYLOAD_NVM_LOG=$DIR_PATH/indll_hro_payload_nvm.log
# rm $INDll_HRO_PAYLOAD_NVM_LOG

INDcm_BC_PAYLOAD_NVM_LOG=$DIR_PATH/indcm_bc_payload_nvm.log
rm $INDcm_BC_PAYLOAD_NVM_LOG
INDcm_SC_PAYLOAD_NVM_LOG=$DIR_PATH/indcm_sc_payload_nvm.log
rm $INDcm_SC_PAYLOAD_NVM_LOG
INDcm_LP_PAYLOAD_NVM_LOG=$DIR_PATH/indcm_lp_payload_nvm.log
rm $INDcm_LP_PAYLOAD_NVM_LOG
INDcm_HR_PAYLOAD_NVM_LOG=$DIR_PATH/indcm_hr_payload_nvm.log
rm $INDcm_HR_PAYLOAD_NVM_LOG
# # INDcm_HRO_PAYLOAD_NVM_LOG=$DIR_PATH/indcm_hro_payload_nvm.log
# # rm $INDcm_HRO_PAYLOAD_NVM_LOG
...
numactl --membind=0 ../../bin/main --algo=phj_shr_lp --workload=payload --subtype=16 --param=pkfk >> $SHRll_LP_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_sc --workload=payload --subtype=16 --param=pkfk >> $SHRll_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_hr --workload=payload --subtype=16 --param=pkfk >> $SHRll_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_bc --workload=payload --subtype=16 --param=pkfk >> $SHRcm_BC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_sc --workload=payload --subtype=16 --param=pkfk >> $SHRcm_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_lp --workload=payload --subtype=16 --param=pkfk >> $SHRcm_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_hr --workload=payload --subtype=16 --param=pkfk >> $SHRcm_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_ind_sc --workload=payload --subtype=16 --param=pkfk >> $INDll_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_lp --workload=payload --subtype=16 --param=pkfk >> $INDll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_hr --workload=payload --subtype=16 --param=pkfk >> $INDll_HR_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_bc --workload=payload --subtype=16 --param=pkfk >> $INDcm_BC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_sc --workload=payload --subtype=16 --param=pkfk >> $INDcm_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_lp --workload=payload --subtype=16 --param=pkfk >> $INDcm_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_hr --workload=payload --subtype=16 --param=pkfk >> $INDcm_HR_PAYLOAD_NVM_LOG
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_lp --workload=payload --subtype=32 --param=pkfk >> $SHRll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_sc --workload=payload --subtype=32 --param=pkfk >> $SHRll_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_hr --workload=payload --subtype=32 --param=pkfk >> $SHRll_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_bc --workload=payload --subtype=32 --param=pkfk >> $SHRcm_BC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_sc --workload=payload --subtype=32 --param=pkfk >> $SHRcm_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_lp --workload=payload --subtype=32 --param=pkfk >> $SHRcm_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_hr --workload=payload --subtype=32 --param=pkfk >> $SHRcm_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_ind_sc --workload=payload --subtype=32 --param=pkfk >> $INDll_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_lp --workload=payload --subtype=32 --param=pkfk >> $INDll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_hr --workload=payload --subtype=32 --param=pkfk >> $INDll_HR_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_bc --workload=payload --subtype=32 --param=pkfk >> $INDcm_BC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_sc --workload=payload --subtype=32 --param=pkfk >> $INDcm_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_lp --workload=payload --subtype=32 --param=pkfk >> $INDcm_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_hr --workload=payload --subtype=32 --param=pkfk >> $INDcm_HR_PAYLOAD_NVM_LOG
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_lp --workload=payload --subtype=64 --param=pkfk >> $SHRll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_sc --workload=payload --subtype=64 --param=pkfk >> $SHRll_SC_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_hr --workload=payload --subtype=64 --param=pkfk >> $SHRll_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_bc --workload=payload --subtype=64 --param=pkfk >> $SHRcm_BC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_hr --workload=payload --subtype=64 --param=pkfk >> $SHRcm_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_sc --workload=payload --subtype=64 --param=pkfk >> $SHRcm_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_lp --workload=payload --subtype=64 --param=pkfk >> $SHRcm_LP_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_ind_sc --workload=payload --subtype=64 --param=pkfk >> $INDll_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_lp --workload=payload --subtype=64 --param=pkfk >> $INDll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_hr --workload=payload --subtype=64 --param=pkfk >> $INDll_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_bc --workload=payload --subtype=64 --param=pkfk >> $INDcm_BC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_sc --workload=payload --subtype=64 --param=pkfk >> $INDcm_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_lp --workload=payload --subtype=64 --param=pkfk >> $INDcm_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_hr --workload=payload --subtype=64 --param=pkfk >> $INDcm_HR_PAYLOAD_NVM_LOG
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_lp --workload=payload --subtype=128 --param=pkfk >> $SHRll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_hr --workload=payload --subtype=128 --param=pkfk >> $SHRll_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_sc --workload=payload --subtype=128 --param=pkfk >> $SHRll_SC_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_bc --workload=payload --subtype=128 --param=pkfk >> $SHRcm_BC_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_lp --workload=payload --subtype=128 --param=pkfk >> $SHRcm_LP_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_sc --workload=payload --subtype=128 --param=pkfk >> $SHRcm_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_hr --workload=payload --subtype=128 --param=pkfk >> $SHRcm_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_ind_sc --workload=payload --subtype=128 --param=pkfk >> $INDll_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_lp --workload=payload --subtype=128 --param=pkfk >> $INDll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_hr --workload=payload --subtype=128 --param=pkfk >> $INDll_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_bc --workload=payload --subtype=128 --param=pkfk >> $INDcm_BC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_hr --workload=payload --subtype=128 --param=pkfk >> $INDcm_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_sc --workload=payload --subtype=128 --param=pkfk >> $INDcm_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_lp --workload=payload --subtype=128 --param=pkfk >> $INDcm_LP_PAYLOAD_NVM_LOG
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_sc --workload=payload --subtype=256 --param=pkfk >> $SHRll_SC_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_lp --workload=payload --subtype=256 --param=pkfk >> $SHRll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_hr --workload=payload --subtype=256 --param=pkfk >> $SHRll_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_bc --workload=payload --subtype=256 --param=pkfk >> $SHRcm_BC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_hr --workload=payload --subtype=256 --param=pkfk >> $SHRcm_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_lp --workload=payload --subtype=256 --param=pkfk >> $SHRcm_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_uni_sc --workload=payload --subtype=256 --param=pkfk >> $SHRcm_SC_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_ind_sc --workload=payload --subtype=256 --param=pkfk >> $INDll_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_lp --workload=payload --subtype=256 --param=pkfk >> $INDll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_hr --workload=payload --subtype=256 --param=pkfk >> $INDll_HR_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_bc --workload=payload --subtype=256 --param=pkfk >> $INDcm_BC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_sc --workload=payload --subtype=256 --param=pkfk >> $INDcm_SC_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_lp --workload=payload --subtype=256 --param=pkfk >> $INDcm_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_ind_uni_hr --workload=payload --subtype=256 --param=pkfk >> $INDcm_HR_PAYLOAD_NVM_LOG
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_sc --workload=payload --subtype=512 --param=pkfk >> $SHRll_SC_PAYLOAD_NVM_LOG
cd ../../
./clean.sh
mkdir build
cd build
...
make -j 32
cd ../scripts/1017-scripts
numactl --membind=0 ../../bin/main --algo=phj_shr_lp --workload=payload --subtype=512 --param=pkfk >> $SHRll_LP_PAYLOAD_NVM_LOG
numactl --membind=0 ../../bin/main --algo=phj_shr_hr --workload=payload --subtype=512 --param=pkfk >> $SHRll_HR_PAYLOAD_NVM_LOG
COMMENT
