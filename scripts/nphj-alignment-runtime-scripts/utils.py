...
color_list = [
	...
	# "moccasin", "coral", "mediumpurple", "lime", "hotpink"
	"orange", "orangered", "rebeccapurple", "deeppink", "seagreen"
]
...
def get_counter_from_log(filepath, flag):
	with open(filepath, "r") as f:
		while True:
			line = f.readline()
			if not line:
	...
	return buildpart_counter, probejoin_counter, total_counter
